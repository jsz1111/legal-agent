# src/agents/legal_knowledge/hallucination_check.py（从 agents/knowledge/hallucination_check.py 迁移）
...
from src.agents.legal_knowledge.knowledge_prompts import HALLUCINATION_CHECK_PROMPT
